...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
        () =>
            _kurirController.isLoading.value || _akunController.isLoading.value
            ? LoadingScreen()
                      ...
                      child: Column(
                        children: [
                          ...
                          GridView.count(
                            ...
                            crossAxisSpacing: 12,
                            children: [
                              for (var data in _kurirController.kurirTersedia)
                                _buildDriverCard(
                                  data["akun"]["nama_lengkap"] ?? "-",
                                  data["akun"]["foto_profile"] ?? "",
                                ),
                            ],
                          ),
  ...
  Widget _buildDriverCard(String name, String urlProfile) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(12),
      ...
      child: Column(
        ...
        children: [
          urlProfile != ""
              ? ClipRRect(
                  borderRadius: BorderRadiusGeometry.all(Radius.circular(3000)),
                  child: Image.network(
                    urlProfile,
                    width: 65,
                    height: 65,
