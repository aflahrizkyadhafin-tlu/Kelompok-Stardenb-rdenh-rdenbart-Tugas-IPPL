      ...
      body: SafeArea(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              crossAxisAlignment:
                  CrossAxisAlignment.start, // Agar elemen rata kiri
              children: [
                // --- 1. BAGIAN HEADER ---
                ...
                Padding(
                  ...
                  child: Transform.translate(
                    ...
                    child: Text(
                      "Masukkan kode OTP yang sudah kita kirim ke email anda", // <-- KETIK TEKS INSTRUKSI LENGKAP DI SINI
    ...
    return Row(
      children: [
        ...
        Transform.translate(
          offset: Offset(-26, 0),
          child: Text(
            "Lupa Password", // <-- KETIK JUDUL HALAMAN DI SINI
            style: GoogleFonts.poppins(
              fontSize: 22,
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.poppins(
              ...
              color: Color(0xFF9E1217),
              letterSpacing:
                  2.0, // Memberi jarak sedikit antar angka agar persis di desain
            ),
          ),
        ],
      ),
    ...
    return Row(
      ...
      children: List.generate(6, (index) {
        return SizedBox(
          width: 45,
          height:
              55, // Dibuat sedikit lebih tinggi agar kotak terlihat memanjang ke bawah
          child: TextField(
            ...
            decoration: InputDecoration(
              counterText:
                  "", // Menghilangkan teks penghitung angka di bawah kotak
