      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildListItem(
              number: "1.",
              title: "Akun Terhapus", // <- Tulis disini: judul item 1, contoh "Akun terhapus"
              description: "Akun anda akan terhapus secara permanen saat ini tanpa ada backup ", // <- Tulis disini: deskripsi item 1, contoh "Akun anda akan terhapus secara permanen saat ini tanpa ada backup"
            ),
            _buildListItem(
              number: "2.",
              title: "Profil", // <- Tulis disini: judul item 2, contoh "profil"
              description: "Informasi personal anda akan terhapus", // <- Tulis disini: deskripsi item 2, contoh "Informasi personal anda akan terhapus"
            ),
            _buildListItem(
              number: "3.",
              title: "Riwayat Transaksi", // <- Tulis disini: judul item 3, contoh "Riwayat transaksi"
              description: "Rincian riwayat transaksi, alamat akan terhapus", // <- Tulis disini: deskripsi item 3, contoh "Rincian riwayat transaksi, alamat akan terhapus"
            ),
            ...
            const SizedBox(height: 180), // <- Jarak pengganti area kosong sebelum tombol, sesuaikan jika perlu
